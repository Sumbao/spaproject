...
privileged aspect ProductController_Roo_Controller {
    ...
    void ProductController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("product_createddate_date_format", "dd/MM/yyyy");
        uiModel.addAttribute("product_updateddate_date_format", "dd/MM/yyyy");
    }
    
    void ProductController.populateEditForm(Model uiModel, Product product) {
        uiModel.addAttribute("product", product);
        addDateTimeFormatPatterns(uiModel);
        uiModel.addAttribute("producttypeses", ProductTypes.findAllProductTypeses());
    }
