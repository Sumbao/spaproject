...
privileged aspect CustomerController_Roo_Controller {
    ...
    void CustomerController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("customer_createddate_date_format", "dd/MM/yyyy");
        uiModel.addAttribute("customer_updateddate_date_format", "dd/MM/yyyy");
        uiModel.addAttribute("customer_customerbirthday_date_format", "dd/MM/yyyy");
    }
    
    void CustomerController.populateEditForm(Model uiModel, Customer customer) {
        uiModel.addAttribute("customer", customer);
        addDateTimeFormatPatterns(uiModel);
        uiModel.addAttribute("customertypes", CustomerType.findAllCustomerTypes());
    }
